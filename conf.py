...
BLOG_AUTHOR = "Mehmet Ali İLGAR"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
		(
			(
				("/", "<i class='fa fa-home' aria-hidden='true' title='Home Page'>"),
				("https://www.github.com/ilgarmehmetali", "<i class='fa fa-git' aria-hidden='true' title='My Github Page'></i>"),
				("mailto:mehmet.ali@milgar.net", "<i class='fa fa-envelope' aria-hidden='true' title='Send Me Email'></i>"),
				("/blog/index.atom", "<i class='fa fa-rss' aria-hidden='true' title='Rss feed'></i>"),
			),
			'icon links'
		),
        ("/blog/", "Blog"),
    ...
    "tr": (
		(
			(
				("/tr", "<i class='fa fa-home' aria-hidden='true' title='Ana Sayfa'>"),
				("https://www.github.com/ilgarmehmetali", "<i class='fa fa-git' aria-hidden='true' title='Github sayfam'></i>"),
				("mailto:mehmet.ali@milgar.net", "<i class='fa fa-envelope' aria-hidden='true' title='Email Gönder'></i>"),
				("/tr/blog/index.atom", "<i class='fa fa-rss' aria-hidden='true' title='Rss kaynağı'></i>"),
			),
			'icon links'
		),
		("/tr/blog/", "Blog"),
